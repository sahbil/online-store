package nl.javaspin.store.repository;

import nl.javaspin.store.StoreApp;
import nl.javaspin.store.config.Constants;
import nl.javaspin.store.config.audit.AuditEventConverter;
import nl.javaspin.store.domain.PersistentAuditEvent;
...
import static nl.javaspin.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
